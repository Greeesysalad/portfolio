...
const projects: Project[] = [
...

  {
    ...
    images: [
      ...
      { src: metal3, caption: 'Structural verification of recombinant plasmids via agarose gel electrophoresis. Diagnostic digests using EcoRI and SpeI were performed to confirm the molecular assembly of the constructed plasmids. Well 8 shows the promoterless control, yielding the expected ~2.0 kb backbone and ~0.7 kb sequence fragments. Well 9 contains the recombinant pCusAsPink plasmid. The secondary fragment in Well 9 exhibits a targeted ~160 bp upward shift , successfully confirming the integration of the pCusC promoter into the final construct.' }
    ],
  }
]
